...
docs <- Corpus(DirSource("/Users/marykatekoch/R/BigMouthDemo"))
#check your corpus object
docs # number of documents should match number of files in your corpus folder
...
optimal.topics <- FindTopicsNumber(dtm, topics = 2:5, metrics = "CaoJuan2009", 
                                   method = "Gibbs")
...
write.csv(topicModel.topics,file=paste("LDAGibbs",k,"DocsToTopics.csv"))

# top K terms in each topic
topicModel.terms <- as.matrix(terms(topicModel,5))
topicModel.terms
